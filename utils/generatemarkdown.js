// markdown string for README file given a data object.
function generateMarkdown(response, githubData) {
    return `
  # ${response.project}
  [![License: ${response.license}](https://img.shields.io/badge/License-${response.license}-blue.svg)](https://github.com/pir8scallywag/rymanauditorium9)
